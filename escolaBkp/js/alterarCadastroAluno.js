...
function cadastraEditaAluno(){
	...
	if(typeof retorno == 'undefined'){				
		...
		if ($('#email').val() == "" || $('#email').val() == "-" || $('#email').val() == "não informado" ||
			...
			mensagem("Os campos a seguir são obrigatórios, <br>favor preenche-los!<br><br>Email <br>Cidade <br>Endereço <br>Nome Da Mãe <br>Nome do Pai <br>Número da sua casa <br>Celular", "OK", "bt_ok", "alerta");
