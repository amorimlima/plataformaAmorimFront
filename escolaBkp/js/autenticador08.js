...
var dadosUser = JSON.parse(localStorage.getItem("tbAlunoVariavel"));

if(typeof dadosUser == "undefined" || dadosUser==null ){
	if(usuario == "Aluno"){	
		$.ajax({
			...
			success: function(d) {
				dadosUser = d;
				localStorage.setItem("tbAlunoVariavel", JSON.stringify(d));
			}		
		});
	}
}
