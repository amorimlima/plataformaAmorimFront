	...
	function CarregaServicoGrupo()
	{
		...
		for(var a=0; a< dataGrupo.length; a++)
		{
					...
					for(var b=0; b< dataAlunoVariavel.length; b++)
					{
						...
						$.ajax({
							url:path+"Objetivo/ObjetivoAluno/"+dataAlunoVariavel[b].idalunoVariavel ,
							type:"GET",
							async:false,
						...
						$.ajax({
							url: path+"PlanejamentoRoteiro/HashAtribuicao/"+dataAlunoVariavel[b].idalunoVariavel,
							type:"GET",
							async:false,
							success: function(data){
								LimiteAnterior = data.LimiteAnterior;
								LimiteProximo =  data.LimiteProximo;
								LimiteTT -= LimiteAnterior;
								LimiteTT -= LimiteProximo;
							}
						})
						...
						completosAnterior = completosAnteriorhash2 + completosAnteriorhash3;
						completosProximo = completosProximohash2 + completosProximohash3;
